...
{?>	
	<body>
		...
		<div class="collapse navbar-collapse" id="menu_entete">
		  <ul class="nav navbar-nav">
			<li><a href="index.php"><i class="fa fa-home"></i> Blogue</a></li>
				...
				{?>
				<li><a class="active" href="?controller=article&action=ajout_article">Ajouter un article</a></li>				   
		...
		<!--Corps -->
		<div class="file">
		  <h1>Ajouter un article au Blogue</h1>
		</div>
		<!--Message d'erreur  -->
		<?php 
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-8">	
				<!--Forulaire d'article (titre et photo) -->
				<form method="post" enctype="multipart/form-data" action="?controller=article&action=RegisterAjoutArticle">					
					<div class="thumbnail" style="box-shadow: 2px 2px 20px black; background:#CFE2F1;"> 
						<p class="p2">Catégorie :</p> 						
							<?php
								if($nbCat>0)
								{?>
						...
						<input name="titre" class="form-control" id="titre" type="text" placeholder="Ex: Titre..." required="">
						
						<div class="space"> </div>
							<!--On limite la taille de ll'avatar a 5Mo-->
							<input type="hidden" name="MAX_FILE_SIZE" value="5000000">						
							<p class="p2">Image/Photo<font color="red">*</font> :</p> 								
							<input name="photo" class="form-control" id="photo" type="file" required="">	
						<div class="space"> </div>								
						<p class="p2">Contenu<font color="red">*</font> :</p> 
						<textarea type="text" name="contenu" style="height: 120px;" class="form-control" required=""></textarea>
						<div class="space"> </div>
							<input class="btn_submit" id="submit" type="submit" value="Valider" name="ok" />
							<input class="btn_submit" id="reset" type="reset" value="Annuler" />
						<div class="space"> </div> 
					</div>
				</form>
				</div>
